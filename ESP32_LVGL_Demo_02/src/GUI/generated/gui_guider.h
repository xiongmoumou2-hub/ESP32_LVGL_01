...
#define WIDTH_REFER(x) (x)
	...
	typedef struct
	{
		...
		lv_meter_scale_t *WidgetsDemo_meter_Sessions_scale_0;
		...
		lv_meter_scale_t *WidgetsDemo_meter_NS_scale_0;
	...
	LV_IMG_DECLARE(_press_alpha_45x36);
	LV_IMG_DECLARE(_clothes_alpha_19x28);
	LV_IMG_DECLARE(_clothes_alpha_19x28);
	LV_IMG_DECLARE(_clothes_alpha_19x28);
	LV_IMG_DECLARE(_clothes_alpha_19x28);
	LV_IMG_DECLARE(_clothes_alpha_19x28);
	...
	LV_FONT_DECLARE(lv_font_montserratMedium_6)
