...
void handleButton(int btnNum)
{
  ...
  switch (btnNum)
  {
    ...
    case 2:
      ...
      tft.pushImage(0, 0, 233, 128, image3);
      break;
    case 3:
      ...
      break;
    case 4:
      tft.fillRect(10, 75, 140, 16, TFT_ORANGE);
      break;
    case 5:
      tft.drawCircle(80, 83, 8, TFT_ORANGE);
      break;
    case 6:
      tft.fillCircle(80, 83, 8, TFT_ORANGE);
      break;
...
void setup()
{
  ...
  // 开机引导提示
  tft.setTextColor(TFT_YELLOW, TFT_BLACK);
  tft.drawString("Press KEY 1 ", 10, 40, 2);
